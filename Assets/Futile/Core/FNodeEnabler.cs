...
public class FNodeEnablerForPreUpdate : FNodeEnabler {
	public Action handleUpdateCallback;
	
	public FNodeEnablerForPreUpdate(Action handleUpdateCallback) {
...
public class FNodeEnablerForUpdate : FNodeEnabler {
	...
	public FNodeEnablerForUpdate(Action handleUpdateCallback) {
		this.handleUpdateCallback = handleUpdateCallback;	
	}
...
public class FNodeEnablerForAfterUpdate : FNodeEnabler {
	...
	public FNodeEnablerForAfterUpdate(Action handleUpdateCallback) {
		this.handleUpdateCallback = handleUpdateCallback;	
	}
...
public class FNodeEnablerForLateUpdate : FNodeEnabler {
	public Action handleUpdateCallback;
	public FNodeEnablerForLateUpdate(Action handleUpdateCallback) {
		this.handleUpdateCallback = handleUpdateCallback;	
	}
...
public class FNodeEnablerForAfterDraw : FNodeEnabler {
	...
	public FNodeEnablerForAfterDraw(Action handleUpdateCallback) {
		this.handleUpdateCallback = handleUpdateCallback;	
	}
...
public class FNodeEnablerForFixedUpdate : FNodeEnabler {
	...
	public FNodeEnablerForFixedUpdate(Action handleUpdateCallback) {
		this.handleUpdateCallback = handleUpdateCallback;	
	}
