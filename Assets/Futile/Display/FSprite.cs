...
public class FSprite : FFacetElementNode
{
	...
	override public void PopulateRenderLayer()
	{
		if(_isOnStage && _firstFacetIndex != -1) 
		{
			...
			_concatenatedMatrix.FromTransform3(ref vertices[vertexIndex0], _localVertices[0], _meshZ);
			_concatenatedMatrix.FromTransform3(ref vertices[vertexIndex1], _localVertices[1], _meshZ);
			_concatenatedMatrix.FromTransform3(ref vertices[vertexIndex2], _localVertices[2], _meshZ);
			_concatenatedMatrix.FromTransform3(ref vertices[vertexIndex3], _localVertices[3], _meshZ);
