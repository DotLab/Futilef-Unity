...
public class FSprite : FFacetElementNode {
	...
	//localRect is the TRIMMED rect
	protected Rect _textureRect;
	//textureRect is the UN-TRIMMED rect
	...
	override public void PopulateRenderLayer() {
		if (_isOnStage && _firstFacetIndex != -1) {
			...
			_concatenatedMatrix.FromTransform3(ref vertices[i0], _localVertices[0], _meshZ);
			_concatenatedMatrix.FromTransform3(ref vertices[i1], _localVertices[1], _meshZ);
			_concatenatedMatrix.FromTransform3(ref vertices[i2], _localVertices[2], _meshZ);
			_concatenatedMatrix.FromTransform3(ref vertices[i3], _localVertices[3], _meshZ);
			
			uvs[i0] = _element.uvTopLeft;
			uvs[i1] = _element.uvTopRight;
			uvs[i2] = _element.uvBottomRight;
			uvs[i3] = _element.uvBottomLeft;
			
			colors[i0] = _alphaColor;
			colors[i1] = _alphaColor;
			colors[i2] = _alphaColor;
			colors[i3] = _alphaColor;
